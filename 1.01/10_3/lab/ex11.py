...
# parentheses, or both?
#no function command VSC gives recommendation for adding parentheses
...
#it still solves the equation =4 the ++ character become highlighted red 

# 4. In math notation, leading zeros are ok, as in 09. What happens if you try
# this in Python?  What about 011?


#does not let you run the command with a zero in front of a number 
...
print("22""11")
# The command will print out as "2211"